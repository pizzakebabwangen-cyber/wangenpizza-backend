...
namespace WangenPizza.Interfaces
{
    public interface ICartService
    {
      ...
      //  IEnumerable<OrderItem> GetOrderItemByOrderId2(int id);
        ...
        /// <summary>Aktueller Rabattcode für die Menü-Anzeige. Null = kein Banner anzeigen.</summary>
        Task<DiscountCode?> GetActiveMenuOfferAsync();
        ...
        /// <summary>Bei gekauften Wertgutscheinen: eindeutige Einlöse-Codes erzeugen, in DiscountCode speichern und an der Bestellung festhalten (idempotent).</summary>
        Task IssuePurchasedWertgutscheinCodesIfNeededAsync(int orderId);
      }
}
