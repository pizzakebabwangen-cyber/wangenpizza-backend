        ...
        public DomainProfile()
        {
            ...
            CreateMap<OrderDto, Order>()
                .ForMember(dest => dest.Street, opt => opt.MapFrom(src =>
                    StreetAddressHelper.CombineStreetAndHausnummer(src.Street, src.Hausnummer)));
            //---------------
            ...
            //---------------
            CreateMap<RestaurantSettings, RestaurantSettingsDto>();
            CreateMap<RestaurantSettingsDto, RestaurantSettings>();
